	...
	static buildPreviewCss(fontSize: number): string {
		...
		return `
			...
			*,*::before,*::after{box-sizing:border-box}
			...
			.bill{font-size:inherit;}
			.bill .sheet{font-size:inherit;}
			.bill .invoice-container{font-size:inherit;}
			.bold{font-weight:bold}
			.bill,.sheet{color:#000;max-width:100%}
			.bill{display:block;overflow:hidden !important}
			.bill .sheet{box-shadow:none !important;margin:0;overflow:hidden;position:relative;box-sizing:border-box;page-break-after:always;font-family:"Times New Roman", Times, serif;background:#fff}
			.bill .sheet .page-footer,.bill .sheet .page-footer-space{height:10mm}
			.bill .sheet .items-block {--col-price: 20%; --col-qty: 12%; --col-discount: 20%; --col-total: 30%;}
			...
			.bill .header .address{font-size:0.8em;font-style:italic}
			...
			.bill .items{--col-name:16%;--col-qty:18%;--col-price:28%;--col-total:30%}
			...
			.bill .invoice-container{font-family:Arial, Helvetica, sans-serif;font-size:1em}
			...
			.bill .header-right{flex:0 0 auto;text-align:right}
			.bill .store-name{font-size:1em;font-weight:700}
			.bill .store-address,.bill .store-phone{font-size:0.8em}
			.bill .invoice-title{font-size:1.3em;font-weight:800;line-height:1.1;margin:6px 0}
			.bill .invoice-meta{margin:4px 0 6px 0;font-size:1em}
			.bill .meta-label{font-weight:700;margin-right:6px}
			.bill .meta-sep{margin:0 6px}
			.bill .invoice-for{margin-top:6px;font-size:0.8em}
			.bill .customer-name{font-size:0.8em;font-weight:700;margin-top:2px}
			.bill .customer-company{font-size:0.7em}
			.bill .qr-box{padding:8px;text-align:right}
			.bill .qr-text{font-size:0.7em;line-height:1.2;margin-bottom:6px}
			...
			.bill .items-table{table-layout:fixed;--col-name:16%;--col-qty:18%;--col-price:28%;--col-total:30%}
			.bill .items-table thead tr,
			.bill .items-table tbody tr{display:flex;flex-wrap:wrap;width:100%}
			.bill .items-table th,
			.bill .items-table td{flex:0 1 auto;padding:4px 2px;vertical-align:top}
			...
			.bill .items-table .col-name,
			.bill .items-table .col-empty{min-width:var(--col-name)}
			.bill .items-table .col-qty{min-width:var(--col-qty)}
			.bill .items-table .col-price{min-width:var(--col-price)}
			.bill .items-table .col-total{min-width:var(--col-total);flex:1 1 auto}
			.bill .items-table th.col-qty,
			.bill .items-table th.col-price,
			.bill .items-table th.col-total,
			.bill .items-table td.text-right{text-align:right}
			.bill .items-table td.text-right{white-space:nowrap;word-break:normal;overflow-wrap:normal}
			.bill .items-table td[colspan]{min-width:100%;max-width:100%;flex:1 1 100%}
			.bill .item-name{display:flex;gap:6px}
			.bill .item-index{min-width:18px}
			.bill .item-sub{font-size:0.8em;color:#444;margin-left:18px}
			.bill .section-title{font-weight:700;margin:4px 0}
			.bill .discount-table tr{display:flex;flex-wrap:wrap;width:100%}
			.bill .discount-table td{flex:0 1 auto;padding:4px}
			.bill .discount-table tr+tr td{border-top:1px solid #eee}
			.bill .discount-table .col-name{flex:1 1 auto;min-width:0}
			.bill .discount-table .col-amount{
				flex:0 0 30%;
				margin-left:auto;
				text-align:right;
				white-space:nowrap;
			...
			.bill .payment-qr-sub{font-size:0.7em;margin-bottom:6px}
			...
			.bill .summary-table .value{text-align:right;font-weight:700;white-space:normal;word-break:normal;overflow-wrap:break-word;}
			.bill .summary-table .summary-total .value{font-size:1em}
			.bill .summary-table .summary-grand .value{font-size:1em}
			.bill .footer-notes{text-align:center;font-size:0.7em;line-height:1.4}
