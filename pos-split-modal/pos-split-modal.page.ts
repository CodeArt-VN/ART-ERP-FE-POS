...
import { CRM_ContactProvider, POS_TableGroupProvider, POS_TableProvider, SALE_OrderDetailProvider, SALE_OrderProvider, WMS_ItemProvider } from 'src/app/services/static/services.service';
    ...
    tableSearch() {
        ...
        this.tableList$ = concat(
            ...
            this.tableListInput$.pipe(
                ...
                switchMap(term => this.tableProvider.search({ Take: 20, Skip: 0, Name: term ? term : this.currentTable.Id }).pipe(
                    catchError(() => of([])), // empty list on error
